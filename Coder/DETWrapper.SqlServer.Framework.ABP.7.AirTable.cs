...
namespace ISoft.Coder
{
    public partial class SqlServerClassGenWrapper
    {
        ...
        {
{ "rechjp2NhdYLmO8ch", " New Management - ToopFix update " },
{ "reckkLu4zY3ZQq18G", "Archive Listings" },
{ "recAqHQETknlb0VSL", "Bond refund - SACAT hearing" },
...
{ "recvC2C1NnYYMrFPC", "Letting only - Leasing" },
...
{ "rechZ70ZRFzW2hZI5", "Management Lost - ToopFix update" },
...
{ "recAqBWTk0eJu5VwA", "New Management - Routine Inspection update" },
...
{ "recZTFJlaZYGrRYwd", "Vacating Tenant" },
        ...
        private static List<(
            ...
            {
( "rechjp2NhdYLmO8ch", " New Management - ToopFix update ", "rec0jcRollHBIb58o", 1, "Enter maintenance instructions into owner profile", "" ),
( "rechjp2NhdYLmO8ch", " New Management - ToopFix update ", "recNiJnFoYEM1Z9ni", 2, "Compliance & Preventative Maintenance required", "" ),
( "rechjp2NhdYLmO8ch", " New Management - ToopFix update ", "recTXmcKq8k6C1FWF", 3, "Compliance & Preventative Maintenance package ordered", "" ),
( "rechjp2NhdYLmO8ch", " New Management - ToopFix update ", "recSjNFaCgPK6pSjT", 4, "Download checklist & save to PropertyMe before deleting records", "" ),
...
( "recAwschExegCxyPv", "Bond refund - Silent bond claim", "rec94u7v4eaWNbEZt", 3, " Claim denied - SACAT hearing required", "recnOgfZkcnlF2mDk" ),
...
( "recAwschExegCxyPv", "Bond refund - Silent bond claim", "recELAl0AbXMhYI1m", 6, "Insurance claim for rent loss required", "rec552xxtTYhL0OUL" ),
...
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "rec70Iuh6QPqmW1IS", 24, "Do you need to lodge a silent bond claim?", "recAwschExegCxyPv" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recubV33AWqWC4VS6", 25, "SACAT hearing required - tenant has disputed", "recnOgfZkcnlF2mDk" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recZbAl4kvuRMg0e4", 26, "Check if an insurance claim for loss of rent is required", "rec552xxtTYhL0OUL" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recOzqPWdli8ba2DD", 27, "Tenant archived in PropertyMe", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recvM4wHvKMlj6Asn", 28, "Download checklist &  save to PropertyMe before deleting the records", "" ),
...
( "recdDAFpR7P9BZT63", "Change of Ownership - Front of House", "reccuaQ9vBEiXOmLQ", 2, "Set a task for Finance Manager advising property has been sold & expected settlement date", "recMxPUoy48RNdMJY" ),
...
( "recdDAFpR7P9BZT63", "Change of Ownership - Front of House", "recggL4gaE9Yj7zg7", 7, "Save management agreement to PropertyMe", "recVdNbgKQs5kQysD" ),
...
( "rec3kMWgFCTdQDVNr", "Final inspection", "recoRCIpocTQUjHyE", 1, "Final inspection completed & reviewed", "recrXtsG7zLhEEH1Y" ),
...
( "rec3kMWgFCTdQDVNr", "Final inspection", "recyDACoUdbJ96oC1", 9, "Work orders issued for cleaning/repairs/gardening required", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "reckRoKkn7Ng4UyTB", 10, "Has the tenant returned all keys, remotes etc", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "rec4LFF3mvDWjnOFK", 11, "Tenant keys checked,  tagged and placed in tenant key box", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recPnlmXfbjPRNp6t", 12, "Are there any abandoned goods?", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recqpK921JxXjuVFt", 13, "Download checklist & save to PropertyMe before deleting", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "reca7nZOw41Hg6AsI", 1, "Call to unsuccessful tenant", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "rec0Pxig9Mwaq2CWN", 2, "Applications reviewed", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recS3s4Kx1NSvLmyU", 3, "Enter tenant details onto PropertyMe", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recm1adXGMyvKDu8H", 4, "Weekly REA summary sent to landlord", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recQNjjMY9NfkLzrN", 5, "Complete reference script & application cover sheet", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recWReIma9Pl1jymR", 6, "Call to successsful tenant", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "reckLGKw3rrd3AEvl", 7, "Applications received", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "rec7komkrgG7jMKQc", 8, "Confirm Special conditions required on tenancy agreemnet", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recyw4Z8VeGrKKv2V", 9, "Send confirmation email to landlord", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recaX9O5On9EfDTQ8", 10, "Application accepted by landlord", "recuONcwG7nSwXNYk" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recEaQOV9xGE2OH0g", 11, "Property availability date confirmed", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recHl880iuMgccCDq", 12, "Application referred to landlord", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recAkJOhFGU5tV7cV", 13, "Download checklist & save to Property Me", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recWr6hAxummoA70f", 14, "Bond and rent received in trust", "" ),
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recwE7wFK175BuOzN", 15, "Tenancy agreement sent to tenant with confirmation email", "recBOXKJRV9wtZd5k" ),
...
( "recveQfCQNrmxLTLw", "Find a Tenant - Relet", "recnWJrOlhizAeV6N", 6, "Send link to realestate.com.au to landlord in case they wish to change the ad", "" ),
( "recveQfCQNrmxLTLw", "Find a Tenant - Relet", "rec7vZK9CD4fMvjyD", 8, "Enter marketing fees into CampaignTrack", "" ),
...
( "recveQfCQNrmxLTLw", "Find a Tenant - Relet", "recdm48o36tasNqkk", 14, "Application accepted by landlord", "recTUadxm4JaCRJxy" ),
...
( "recveQfCQNrmxLTLw", "Find a Tenant - Relet", "recr9SHXRxPEPQjyK", 20, "Enter tenant details into PropertyME", "" ),
( "recveQfCQNrmxLTLw", "Find a Tenant - Relet", "rec1Kc95hVF2yUycM", 21, "Tenancy agreement sent to tenant with confirmation email", "recBOXKJRV9wtZd5k" ),
( "recveQfCQNrmxLTLw", "Find a Tenant - Relet", "recCEU8A97nNMhzyz", 22, "Bond and Rent Received in Trust", "" ),
( "recveQfCQNrmxLTLw", "Find a Tenant - Relet", "recVAOKHrs1nuincK", 23, "Download checklist &  save to PropertyMe before deleting the records", "" ),
...
( "recS7t5XgcjtP6czs", "Management lost", "reccernEz8Fbdqsj8", 6, "Is this a management transfer to another agent or landlord?", "recqL05XEPWRAyN7N" ),
...
( "recS7t5XgcjtP6czs", "Management lost", "reckzqLzfuCjlf51I", 11, "Put funds on hold for outstanding maintenance", "" ),
( "recS7t5XgcjtP6czs", "Management lost", "recAgcHLtTC950B7B", 12, "Attached 'Not for Relet' label to property", "" ),
( "recS7t5XgcjtP6czs", "Management lost", "recfPd0VdECmBLlQY", 13, "ToopFix outstanding work orders to be checked", "recRhqQ8cFKmwrc1E" ),
( "recS7t5XgcjtP6czs", "Management lost", "recqHn6YJsKQsq2Uc", 14, "Create an orange alert to show on bills feature", "" ),
( "recS7t5XgcjtP6czs", "Management lost", "recHwbDDQUlcUtVml", 15, "Management officially lost", "reczUiVevW9QXrFty" ),
...
( "reczUiVevW9QXrFty", "Management Lost - Landlord Offboard", "recwUzaNyTYBxGVb4", 15, "Inactivate Property in Inspection Manager", "reci2VK2nPUi5WNG7" ),
...
( "recRhqQ8cFKmwrc1E", "Management Lost - ToopFix update ", "recPtZJu2jOyN1zqv", 0, "Download checklist & save to PropertyMe", "" ),
( "recRhqQ8cFKmwrc1E", "Management Lost - ToopFix update ", "rec0G1mzIRZXXOpJ8", 0, "Is a Compliance & Preventative maintenance package pending", "" ),
( "recRhqQ8cFKmwrc1E", "Management Lost - ToopFix update ", "rece3gWhWYNz8jU27", 0, "Check for current work orders pending completion", "" ),
...
( "recODcelPqqjKNlWb", "Management Takeover", "rec9oMgyYAWitHI23", 8, "Make a receipt note that letting fee is not to be deducted", "" ),
...
( "rec58orUTPPCa5hkG", "New management - Front of House", "recI9gx7cPAWBL1QJ", 1, "Trigger New Management  Leasing checklist", "rec5pCUteKFxm8Nkt" ),
( "rec58orUTPPCa5hkG", "New management - Front of House", "recwbPoyNhI2uwIeR", 2, "Is this a letting only?", "recRYAdVQ7oKFeXRZ" ),
( "rec58orUTPPCa5hkG", "New management - Front of House", "recB6le7D24oZHoYy", 3, "Is this a management takeover?", "recODcelPqqjKNlWb" ),
( "rec58orUTPPCa5hkG", "New management - Front of House", "recFejiaVRLFp4ijT", 4, "Is this a change of ownership - see notes", "recdDAFpR7P9BZT63" ),
( "rec58orUTPPCa5hkG", "New management - Front of House", "recWnCVoEXhj2F6q4", 5, "Enter property address into PropertyMe", "" ),
( "rec58orUTPPCa5hkG", "New management - Front of House", "recUGuCGtm8UnpUxq", 6, "Change property manager's name", "" ),
( "rec58orUTPPCa5hkG", "New management - Front of House", "rectyWO1PdZ7fmipx", 7, "Enter property details (refer to page 11 of agreement))", "" ),
( "rec58orUTPPCa5hkG", "New management - Front of House", "recyyeRAg3E9OiI6d", 8, "Invoices to be paid by T+T (refer to page 3)", "" ),
( "rec58orUTPPCa5hkG", "New management - Front of House", "recoObxbZOLFvp9lG", 9, "Enter special conditions for tenancy agreement", "" ),
...
( "rec58orUTPPCa5hkG", "New management - Front of House", "recHHrhmFJo04EXPk", 26, "ToopFix update for compliance & maintenance instructions", "" ),
( "rec58orUTPPCa5hkG", "New management - Front of House", "recBw8zbzRLQr8YWM", 27, "Routine Inspection Schedule update required", "" ),
( "rec58orUTPPCa5hkG", "New management - Front of House", "recos0IotcRLoL6Z6", 28, "New management thankyou email to be sent", "reckrmSdfKx35zqYo" ),
( "rec58orUTPPCa5hkG", "New management - Front of House", "recXgmGok5fSvL78s", 29, "Save Management Agreement into PropertyMe", "" ),
...
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recViq1UMSLYHu714", 2, "Management takeover - contact the current agent to arrange handover date", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recJpHwXPfGp6EGw8", 3, "Management takeover - advise PM to diarise date for collection of documents", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recKp75SGplCy4HnP", 4, "Switch Management takeover - seek approval from the GM to make takeover cost neutral", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recX82yzpndDFwydS", 5, "Switch Management takeover - obtain copy of owner's statement from previous agent", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recae7wF7LoERrUQ1", 6, "Switch Management takeover - save statement to PM", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recIDsr0WabsVMMLu", 7, "Switch Management takeover - set task for Finance Manager", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "rec5Q2r1kl5Q5kyKm", 8, "Create marketing copy in TMP & REX", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recoFrnpd1PfpggzT", 9, "Order marketing items & enter cost onto CampaignTrack", "recUGZNj1CBvk6xC0" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "reclO6SJR1dWS2XOs", 10, "If referred by a sales partner, email them to confirm property listed", "" ),
...
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recHvvXtoQj5LjwO9", 12, "Check that application for landlord insurance has been sent", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recvszII1NWChZT1j", 13, "Scan Appliance Manuals into PropertyMe", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recQwraiFAHMSh7ao", 14, "3 sets of keys/remotes/access card have been received & registered in PropertyMe", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "rect1tl6e2gUNG3Ma", 15, "Download checklist and save to PropertyMe before deleting records", "" ),
( "reckrmSdfKx35zqYo", "New management - Property Manager", "recXQB5YFuWGO82qs", 1, "Send new management thankyou email to owner", "" ),
...
( "recBOXKJRV9wtZd5k", "New tenant - Ingoing Inspection", "recFRfCJpJFCl052R", 5, "Master key template attached to ingoing report", "" ),
( "recBOXKJRV9wtZd5k", "New tenant - Ingoing Inspection", "recQngiuU8s2kGxqD", 6, "Report sent to tenant", "" ),
( "recBOXKJRV9wtZd5k", "New tenant - Ingoing Inspection", "recndTErTmHdXwjP4", 7, "Report sent to landlord", "" ),
( "recBOXKJRV9wtZd5k", "New tenant - Ingoing Inspection", "recfjkeZWDkTQrSo5", 8, "Download checklist &  save to PropertyMe before deleting the records", "" ),
( "recw9eRfgHy6OOOgP", "New Tenant - Water invoicing", "recq3WS3d6HIGefgp", 1, "Send invoice to tenant for water supply", "" ),
( "recw9eRfgHy6OOOgP", "New Tenant - Water invoicing", "recDkZtwYQaVYOYtr", 2, "Add label to property with ingoing meter reading", "" ),
( "recw9eRfgHy6OOOgP", "New Tenant - Water invoicing", "recQbBsD6iNGDmHnx", 3, "Download checklist & save to PropertyMe", "" ),
...
( "recnPTSIEucW8pZV6", "Reinstated management", "recDJyXHUicClLrKm", 7, "Property to be added back onto routine spreadsheet", "" ),
...
( "recnPTSIEucW8pZV6", "Reinstated management", "rec13YmXjO2DhPYni", 13, "Does the landlord require reinstatement of landlord insurance:", "" ),
( "recnPTSIEucW8pZV6", "Reinstated management", "recn655CskH87fwJ8", 14, "Does a Compliance and Preventative Maintenance package need to be reinstated", "rechjp2NhdYLmO8ch" ),
( "recnPTSIEucW8pZV6", "Reinstated management", "recORnP0m61oigJzJ", 15, "Leasing team member advised to relet", "recveQfCQNrmxLTLw" ),
...
( "rec3puMpgXTmmRq2L", "Rent Arrears - 16 days", "recBRhPHUySPp1e4x", 9, "Commence application to SACAT", "recjjTN3bn9GkpPJn" ),
...
( "recjjTN3bn9GkpPJn", "SACAT Hearings", "reclwh8PfzKELRlJ3", 7, "Is the determination for amounts claimed different.  If so, amend internal invoices", "" ),
...
( "recjjTN3bn9GkpPJn", "SACAT Hearings", "receCYT2QMvAD4ZQ4", 12, "Order for possession - commence vacating process", "recZTFJlaZYGrRYwd" ),
...
( "recuONcwG7nSwXNYk", "Tenant confirmed - New Management", "recb9qpjaVjI17EeO", 10, "Remove the property from your Pan list", "recK695XnaMlEIN7D" ),
( "recuONcwG7nSwXNYk", "Tenant confirmed - New Management", "recU0kXpritfi1G2V", 11, "Deactivate Campaign Track", "" ),
...
( "recuONcwG7nSwXNYk", "Tenant confirmed - New Management", "rechtsIrOGXZ1P2MX", 15, "Book meeting room for key collection", "" ),
...
( "recTUadxm4JaCRJxy", "Tenant confirmed - Relet", "recMdSx5nzeXJw6JG", 4, "Water charges changed? Update the label & alert", "" ),
...
( "recTUadxm4JaCRJxy", "Tenant confirmed - Relet", "rectVSp68jVSWCGrD", 13, "Deactivate Campaign Track", "" ),
( "recTUadxm4JaCRJxy", "Tenant confirmed - Relet", "reccTDAFgtaMceJL1", 14, "Remove property from PAN list & place 'Leased' sticker on sign", "recHgZI6oKbaclVf7" ),
( "recTUadxm4JaCRJxy", "Tenant confirmed - Relet", "rect3x4egWRR9oS7u", 15, "Lease Break?   If so change vacating date", "" ),
( "recTUadxm4JaCRJxy", "Tenant confirmed - Relet", "recTJiSV5eejstqG1", 16, "Lease break?  Remove alert against property ", "" ),
( "recTUadxm4JaCRJxy", "Tenant confirmed - Relet", "rec7I6NSgk249EhxS", 17, "Lease break? Advise previous tenant property has been relet", "" ),
( "recTUadxm4JaCRJxy", "Tenant confirmed - Relet", "recpxUjCZDLy9y64i", 18, "Book meeting room for key collection ", "" ),
...
( "recK695XnaMlEIN7D", "Tenant starts - New Management", "rectOKAjrOzRzL95z", 3, "Key receipt signed by tenant & copy provided to them", "" ),
( "recK695XnaMlEIN7D", "Tenant starts - New Management", "recQuEr3sD1qBi8HX", 4, "Set task for lease start date in PropertyMe", "" ),
( "recK695XnaMlEIN7D", "Tenant starts - New Management", "recuEMrXMuSzxd74r", 5, "Meeting with tenant to handover keys", "" ),
( "recK695XnaMlEIN7D", "Tenant starts - New Management", "rectQYYCdoNQ7y1Gy", 6, "Copy of the key receipt has been saved to Property Me", "" ),
( "recK695XnaMlEIN7D", "Tenant starts - New Management", "rec12j5AXT4Sla0gg", 7, "Is this a letting only?", "rec7Ts947EFHbSdTT" ),
( "recK695XnaMlEIN7D", "Tenant starts - New Management", "recs5I396RGXocz7e", 8, "Water invoice to be issued (not for a letting only)", "recw9eRfgHy6OOOgP" ),
...
( "recHgZI6oKbaclVf7", "Tenant starts - Relet", "recG0QTjlJAt66Tpt", 3, "Key receipt signed by tenant & copy provided", "" ),
( "recHgZI6oKbaclVf7", "Tenant starts - Relet", "recgrJjYLETD4Od3Z", 4, "Set task for lease start date In PropertyMe", "" ),
( "recHgZI6oKbaclVf7", "Tenant starts - Relet", "recoljzbehXsbwnfp", 5, "Meeting with tenant to handover keys completed ", "" ),
( "recHgZI6oKbaclVf7", "Tenant starts - Relet", "recLIv8RPpDi6aQiR", 6, "Copy of the key receipt has been saved to PropertyMe", "" ),
( "recHgZI6oKbaclVf7", "Tenant starts - Relet", "rec2yrYoNfu6CQYqR", 7, "Is this a letting only?", "rec7Ts947EFHbSdTT" ),
( "recHgZI6oKbaclVf7", "Tenant starts - Relet", "recODJtRAlJkOkvoX", 8, "Water invoice to be issued (not for a letting only)", "recw9eRfgHy6OOOgP" ),
( "recHgZI6oKbaclVf7", "Tenant starts - Relet", "reciMQFKOdscPUE0Z", 9, "Download checklist &  save to PropertyMe before deleting the records", "" ),
( "recoxn64Do6Toykyg", "Under Renovation", "recAnmj3Yy6s2SM7Q", 1, "Label 'under renovation' & set alert re expected date of completion", "" ),
...
( "recoxn64Do6Toykyg", "Under Renovation", "recdAdPHcLKKRvj1Y", 6, "Do not relet", "recS7t5XgcjtP6czs" ),
( "recoxn64Do6Toykyg", "Under Renovation", "recJEjXJK5mpj0BuD", 7, "Commence advertising", "recveQfCQNrmxLTLw" ),
...
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "reccCPvLCSUIrZ2KC", 2, "Record the vacating date in PropertyMe", "" ),
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "receOjx9lNmC18gyi", 3, "If lease break, create an orange alert against the property", "" ),
...
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recFGd9gzfGAc6ld0", 6, "Final inspection date set in PropertyMe & outlook calendar", "rec3kMWgFCTdQDVNr" ),
...
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recC1lWORn3kL7SkS", 11, "Do not relet", "recS7t5XgcjtP6czs" ),
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recS5Yg9a5rAubxxS", 12, "Is the landlord renovating? Add label in PropertyMe", "recoxn64Do6Toykyg" ),
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recNo9lEz4FBGz1EU", 13, "Does the tenant have a direct debit request set up by Toop&Toop", "" ),
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recBL3BlGUcCssRer", 14, "Commence Advertising", "recveQfCQNrmxLTLw" ),
