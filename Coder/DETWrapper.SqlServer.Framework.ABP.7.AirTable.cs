...
{ "rec01ktODnbBa8EWl", "Letting only - Leasing" },
...
{ "recuLs50IaEPHsTr7", "Management Lost - ToopFix update" },
...
{ "recTJZWFGWoScrxEE", "NSW 2026" },
{ "rectE3D7YBCnBjdbW", "Property for Sale" },
...
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recD0f2ko6bf89d2z", 1, "Does the tenant owe any rent?", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recTQjXx56vPDSuLF", 2, "Is there any claim for rent differential? (account code 101)", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recOCidMhkQY0w5u6", 3, "Is there any claim for water usage &/or supply? (account code 166)", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recWiMtLrTOaDpv9j", 4, "Is there any claims for cleaning?  (account code 162)", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recXw1QvhAlelAUPi", 5, "Is there any claims for repairs?  (account code 180)", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "rec2GOOxUUDjQOmBH", 6, "Is there any claims for key cutting or changing locks? (account code 178)", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recQXi6tpU0C1Okln", 7, "Is there any claims for gardening? (account code 175)", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recXs93upxk3AZArs", 8, "Is there any claim for compensation? (account code 172)", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recqr59TdY15WyS62", 9, "Is there any claims for advertising costs?  (account code 174)", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "reclsXYAOFIQpBLXm", 10, "Is there any claims for lease break costs - letting fee (account code 173)", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recV28WIT1FrIX3Aj", 11, "Does the tenant have any funds under 'Deposits' in Property Me to offset claim", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recDnWi5wSa5ltIul", 12, "Has the tenant paid rent past the vacate date?", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recjEY46kxi18ZP5g", 13, "Overpaid rent - set task for Finance Manager to arrange refund", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recccL6dXi7KSHULy", 14, "Link to bond refund summary sheet", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recY73Tv9SoZemA38", 15, "Email tenants if claims being made", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recpGROyhqSeO2qSg", 16, "Email tenants if no claims being made", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recNqFuGyeFUPcWK9", 17, "Invoices have been received for work completed", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recCDkjWVnTU3sZcp", 18, "Final claim details emailed to tenant", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recUJeyNfyi8X0wL4", 19, "Internal invoices for bond claims raised", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recby4b6khUmhh89w", 20, "Final claim details emailed to landlord", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recTl0FW6d3hPCDar", 21, "Is there a deposit to be refunded to tenant - contacted for their bank account details", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recAIzNEFkLjyfTME", 22, "Deposit has been disbursed to tenant", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "reciO4vjF6qaWNEiq", 23, "Bond refund requested / authorised on Bonds On-Line", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recTLUmWCz5QkqPFi", 24, "Bond refund received", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "rec70Iuh6QPqmW1IS", 25, "Do you need to lodge a silent bond claim?", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recZbAl4kvuRMg0e4", 26, "Check if an insurance claim for loss of rent is required", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recubV33AWqWC4VS6", 27, "SACAT hearing required - tenant has disputed", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "rec1MqPBVac4UkzHl", 28, "Landlord advised that bond monies have been received & receipted", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recvM4wHvKMlj6Asn", 29, "Download checklist &  save to PropertyMe before deleting the records", "" ),
( "recrXtsG7zLhEEH1Y", "Bond Refunds", "recOzqPWdli8ba2DD", 30, "Tenant archived in PropertyMe", "" ),
...
( "rec3kMWgFCTdQDVNr", "Final inspection", "recz6bbFMJSs7D53F", 3, "Are there any cleaning/repairs required (list under personal notes)", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recGMMACGEy2NlQ3r", 4, "Report emailed to the landlord", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recYxpAs7dUrOTKSU", 5, "Email Landlord to advise final inspection has been completed", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recL5iMQxDoxfWFHZ", 6, "Email tenants to advise final inspection has been completed", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recI4Pj7hFKP368BS", 7, "Rent owing - add label 'arrears bond claim' to property", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "rec5K6Atsr8NTYfmR", 7, "Report emailed to the tenant due to issues found", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recmyrPk7vNctsaoj", 8, "Confirm owners bond claim instructions within 48 hours", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recEtiP1DYiGdVWep", 9, "If no claims being made - refer to bond refund checklist", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recm1H6XYRLtBDSt6", 10, "If claims being made - refer to bond refund checklist", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recyDACoUdbJ96oC1", 11, "Work orders issued for cleaning/repairs/gardening required", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "reckRoKkn7Ng4UyTB", 12, "Has the tenant returned all keys, remotes etc", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "rec4LFF3mvDWjnOFK", 13, "Tenant keys checked,  tagged and placed in tenant key box", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recPnlmXfbjPRNp6t", 14, "Are there any abandoned goods?", "" ),
( "rec3kMWgFCTdQDVNr", "Final inspection", "recqpK921JxXjuVFt", 15, "Download checklist & save to PropertyMe before deleting", "" ),
...
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "recvl93UFsQAPTcLq", 8, "Obtain copy of ID documents from tenant", "" ),
...
( "recUGZNj1CBvk6xC0", "Find a Tenant - New Management", "reca7nZOw41Hg6AsI", 16, "Advise unsuccessful tenant/s", "" ),
...
( "recveQfCQNrmxLTLw", "Find a Tenant - Relet", "recaV8fKJ82nkLskq", 16, "Obtain copy of ID from tenant/s", "" ),
...
( "recveQfCQNrmxLTLw", "Find a Tenant - Relet", "recNFZ6El9A1fO0lX", 23, "Advise unsuccessful tenant/s", "" ),
...
( "reczUiVevW9QXrFty", "Management Lost - Landlord Offboard", "recClTQIFLvfOkCYp", 8, "Email sent to  landlord re change of postal address", "" ),
( "reczUiVevW9QXrFty", "Management Lost - Landlord Offboard", "recBuoXYjJPtNh1GT", 8, "If we pay council rates, contact council to redirect", "" ),
( "reczUiVevW9QXrFty", "Management Lost - Landlord Offboard", "rec2FH1ky7dM4EAgA", 8, "If we pay SA Water, redirect accounts to LL", "" ),
...
( "rec58orUTPPCa5hkG", "New management - Front of House", "rec3RDZS4WbYUxXpv", 13, "Add label to property for water charges payable by tenant", "" ),
...
( "rec58orUTPPCa5hkG", "New management - Front of House", "recos0IotcRLoL6Z6", 28, "Save Management Agreement into PropertyMe", "" ),
...
( "rec58orUTPPCa5hkG", "New management - Front of House", "rec8Kcu0BqxL8cPnE", 31, "Ensure property profile is completed ", "" ),
...
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recvdDJZknXr9yVlu", 2, "Call landlord to introduce yourself - advise will send direct contact card", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "reccbKTPG6cLLqhg2", 3, "Send new management - Welcome email", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recViq1UMSLYHu714", 4, "Management takeover - contact the current agent to arrange handover date", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recJpHwXPfGp6EGw8", 5, "Management takeover - advise PM to diarise date for collection of documents", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recKp75SGplCy4HnP", 6, "Switch Management takeover - seek approval from the GM to make takeover cost neutral", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recX82yzpndDFwydS", 7, "Switch Management takeover - obtain copy of owner's statement from previous agent", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recae7wF7LoERrUQ1", 8, "Switch Management takeover - save statement to PM", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recIDsr0WabsVMMLu", 9, "Switch Management takeover - set task for Finance Manager", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "rec5Q2r1kl5Q5kyKm", 10, "Create marketing copy in TMP & REX", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recG4yIeb0Q2VK7TS", 11, "Send link to toop.com.au to landlord to review Ad", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recaEjS9HvPeCM1B0", 12, "Diarise to collect keys and appliance manuals from the owner", "" ),
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recUM0i8KxMkppfqO", 13, "Confirm landlord has completed property profile", "" ),
...
( "rec5pCUteKFxm8Nkt", "New management - Leasing Co-ordinator", "recvszII1NWChZT1j", 14, "Scan Appliance Manuals into PropertyMe", "" ),
...
( "reckrmSdfKx35zqYo", "New management - Property Manager", "recLfxqUvXCTeYvcv", 1, "Send Landlord Contact Card", "" ),
( "reckrmSdfKx35zqYo", "New management - Property Manager", "recXHh6Louvhn4oDe", 2, "Enter property into routine inspection spreadsheet", "" ),
( "reckrmSdfKx35zqYo", "New management - Property Manager", "reclDtOJ9Ip4GHNaP", 3, "Enter routine inspection date against property in Property Me", "" ),
...
( "rectE3D7YBCnBjdbW", "Property for Sale", "recA8MqP2zhkV9U7Z", 1, "Landlord has advised property is on the market for sale", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recRZvtsMvAIPPmTR", 2, "Add 'Property for Sale' label to property in PropertyMe", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "rec0rybjgb565XuqS", 3, "Create an alert on the property in PropertyMe with agent details and date", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recEayvs6rajlLiyQ", 4, "Send sale confirmation email to landlord", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recv935U3t6RQlIOA", 5, "Set a task in property me for 3 weeks to check in regarding sale", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recJpt2FMoNQiMIpr", 6, "If withdrawn from market - Download checklist and delete label, alert and task", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "rec6ZXegkYgbXgbVz", 7, "Create alert against bills ", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recufjh8qXDPOfGyB", 7, "Landlord has advised of settlement date", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recvogiUAkK4viy3V", 8, "Update property alert with settlement date", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "rec91fQvEsn4ubbCv", 9, "Send email to finance officer advising the property is sold and settlement date", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recB4NUNqnGTKzuru", 10, "Confirm purchases details with sales agent", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recIolJkFhARBlE0l", 11, "Place funds on hold for maintenance works if required", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recNzaA7Veo4Ta6OA", 12, "Send email to Client Concierge with purchases details", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recLUSRdKjzMB5wOp", 13, "Sold vacant or at end of tenancy and new owner is moving in?", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "rec6gRSb67pPHyfL9", 14, "New owner taking management?", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recCkLySoB1ZzgPrk", 15, "Retaining management with new owner?", "" ),
( "rectE3D7YBCnBjdbW", "Property for Sale", "recz21638Hn57nYYH", 16, "Download checklist & save to PropertyMe before deleting records", "" ),
...
( "recuONcwG7nSwXNYk", "Tenant confirmed - New Management", "recYcG1iv0hrEL5EH", 17, "Email FOH details for tenant gift", "" ),
...
( "recTUadxm4JaCRJxy", "Tenant confirmed - Relet", "recMdSx5nzeXJw6JG", 4, "Add water charges alert and ingoing meter to tenant invoice", "" ),
...
( "recTUadxm4JaCRJxy", "Tenant confirmed - Relet", "recxZ6V0Ht3gFAlXJ", 21, "Email FOH details for tenant gift", "" ),
...
( "recK695XnaMlEIN7D", "Tenant starts - New Management", "recQuEr3sD1qBi8HX", 4, "Set task for lease start date for PM Reception in PropertyMe", "" ),
...
( "recHgZI6oKbaclVf7", "Tenant starts - Relet", "recgrJjYLETD4Od3Z", 4, "Set task for lease start date for PM reception In PropertyMe", "" ),
...
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recpki26RWDMzcVK6", 6, "Review the tenants ingoing to determine quality of home and bond clean", "" ),
...
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recU5SikAuaF4BtQJ", 11, "Does the property have a pool or irrigation? contact landlord to advise to connect electricity", "" ),
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recC1lWORn3kL7SkS", 12, "Do not relet", "" ),
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recS5Yg9a5rAubxxS", 13, "Is the landlord renovating? Add label in PropertyMe", "" ),
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recBL3BlGUcCssRer", 14, "Commence Advertising", "" ),
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recyuSw5pnI7UULyz", 14, "Send bond guarantee email to Tenant", "" ),
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recOv7SUBICjMd02Y", 15, "Ensure tenant has activated their bond token", "" ),
( "recZTFJlaZYGrRYwd", "Vacating Tenant", "recK6hOOGKYUvXvih", 16, "Download checklist &  save to PropertyMe before deleting the records", "" ),
            };
