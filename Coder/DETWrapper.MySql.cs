...
{
    /// <summary>
    /// Wrapper class for MySql connection
    /// </summary>
    public class MySqlClassGenWrapper : BaseDTEWrapper
    {
        ...
        public MySqlClassGenWrapper(
            MySqlEFContext context, DTE2 app, string ns, Expression<Func<MBTable, bool>> tableFilter = null,
            int batchSize = 50)
